<!--
 * @Author: hy
 * @Date: 2022-03-21 23:06:46
 * @LastEditors: hy
 * @Description: 
 * @LastEditTime: 2022-03-21 23:54:25
 * @FilePath: /interview-questions/packages/front-end-concept/httpStatusCode.md
 * Copyright 2022 hy, All Rights Reserved. 
 * 仅供学习使用~
-->
# http status code

> MDN 【[http status](https://developer.mozilla.org/zh-CN/docs/web/http/status)】

|code|description|
|-|-|
|1xx|Informational（信息响应状态码） => 接受请求正在处理|
|2xx|Success（成功响应状态码） => 请求正常处理完毕|
|3xx|Redirection（重定向响应状态码）=> 需要附加操作已完成请求|
|4xx|Client Error（客户端错误响应状态码）服务器无法处理请求|
|5xx|Server Error（服务器错误响应状态码） => 服务器处理请求出错|
